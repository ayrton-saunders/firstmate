...
For a remote route, the configured code root retains its existing host-local `origin` update before the persistent home fast-forwards to the code-root commit.
