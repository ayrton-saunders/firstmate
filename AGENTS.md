...
config/update-source  optional local canonical Git URL for /updatefirstmate; LOCAL, gitignored, not inherited, and absent defaults to https://github.com/kunchenguid/firstmate.git; see docs/configuration.md "Canonical self-update source"
