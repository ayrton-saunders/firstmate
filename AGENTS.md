...
config/update-source  optional canonical Git URL for /updatefirstmate; LOCAL, gitignored, inherited into secondmate homes, and absent defaults to https://github.com/kunchenguid/firstmate.git; see docs/configuration.md "Canonical self-update source"
