...
config/update-source  optional canonical Git URL for /updatefirstmate; LOCAL, gitignored, inherited into secondmate homes, and absent falls back to origin; see docs/configuration.md "Canonical self-update source"
